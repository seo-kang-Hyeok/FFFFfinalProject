	...
	<main class="pakge-main">
		<div class="package-List">
			...
			<div class="package-card">
				<img src="${pageContext.request.contextPath}/resources/images/pexels-photo-98350981.jpeg" alt="logo"> 
				<h2>감기 탈출 패키지</h2>
				<p>500만원</p>
				<div class="package-card-but">
					<a href="${pageContext.request.contextPath}/item/packageForm.bo" >바로가기</a>
				</div>
			</div>
			...
			<img src="${pageContext.request.contextPath}/resources/images/v22_2.png">
			
			<div id="package-explanation" >
				<a class="explanation-title">' 다양한 채소로 만드는 건강한 식단 '</a>
			</div>
