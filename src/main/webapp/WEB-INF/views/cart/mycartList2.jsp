			...
			<c:forEach items="${cartList}" var="cart">
					<tr>
						...
						<td>
							...
							<h5 class="itemPrice">상품가격${cart.itemPrice}원</h5>
							<h5 class="itemCount">재고량${cart.itemCount}</h5>
						</td>
						<td>
			        		<h4 class="cartCount">수량${cart.cartCount}</h4>
			        		<h4><c:set var= "total" value="${cart.itemPrice * cart.cartCount}"/>
			 				<c:out value="${total}원"/></h4>
						</td>
						<td>					
