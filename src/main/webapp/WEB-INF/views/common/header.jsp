...
<body>
	<header>
		<div class="container">
			...
			<div class="logo">
				<img class="logo" src="${pageContext.request.contextPath}/resources/images/v22_2.png" onclick="window.location.href='${pageContext.request.contextPath}/index.jsp';" alt="logo">
       		</div>
			<div class="middle-links">
       			<ul class="middle-nav">
	            	...
	            	<li><a href="${pageContext.request.contextPath}/item/itemlist.bo">상품판매</a></li>
